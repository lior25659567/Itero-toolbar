function Button() {
  return (
    <div className="absolute bg-gradient-to-b bottom-[5.88%] content-stretch flex from-[#ffffff] items-center justify-center left-[83.43%] px-[24px] py-[22px] right-0 rounded-[4px] to-[#f3f3f3] top-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#939598] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex flex-col font-['Avenir:Roman',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3e3d40] text-[16px] text-center text-nowrap">
        <p className="leading-[20px] whitespace-pre">Change scale</p>
      </div>
    </div>
  );
}
