...
function Button() {
  return (
    <div className="absolute bg-gradient-to-b bottom-[0.65%] content-stretch flex from-[#ffffff] items-center justify-center left-[83.51%] px-[24px] py-[22px] right-0 rounded-[4px] to-[#f3f3f3] top-0" data-name="Button">
