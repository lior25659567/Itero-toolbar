...
function AohsButton({ isActive, onClick }: { isActive?: boolean; onClick?: () => void }) {
  return (
    <div 
      className={`${isActive ? 'bg-[#DFF5FC]' : 'bg-white'} content-stretch flex flex-col items-center justify-between relative rounded-[10px] shrink-0 size-[60px] cursor-pointer`} 
    ...
    <div className="relative size-full" data-name="Screen template" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\\'0 0 1920 1080\\\' xmlns=\\\'http://www.w3.org/2000/svg\\\' preserveAspectRatio=\\\'none\\\'><rect x=\\\'0\\\' y=\\\'0\\\' height=\\\'100%\\\' width=\\\'100%\\\' fill=\\\'url(%23grad)\\\' opacity=\\\'1\\\'/><defs><radialGradient id=\\\'grad\\\' gradientUnits=\\\'userSpaceOnUse\\\' cx=\\\'0\\\' cy=\\\'0\\\' r=\\\'10\\\' gradientTransform=\\\'matrix(69.6 39.825 -70.448 38.956 960 573.75)\\\'><stop stop-color=\\\'rgba(178,205,227,1)\\\' offset=\\\'0\\\'/><stop stop-color=\\\'rgba(221,235,242,1)\\\' offset=\\\'0.94792\\\'/></radialGradient></defs></svg>')" }}>
        ...
        <>
          {activeButtons.has(3) ? (
            <>
              ...
              {activeButtons.has(2) && (
                <div className="absolute top-[93px] right-[228px]">
                  <Frame1618872975 />
                </div>
              )}
            </>
            ...
            <>
              ...
              {activeButtons.has(2) && (
                <div className="absolute top-[93px] right-[106px]">
                  <Frame1618872975 />
                </div>
              )}
            </>
      ...
      {currentPage === 'scan' && layout === 'horizontal-bottom' && (
        <>
          ...
          {activeButtons.has(6) && (
            <div className="absolute bottom-[106px] left-1/2 translate-x-[-50%] w-[1014px] h-[68px] z-40">
              <Scale />
            </div>
          )}
          {activeButtons.has(7) && (
        ...
        <>
          {viewActiveButtons.has(6) ? (
            <>
              ...
              {!viewActiveButtons.has(1) && viewActiveButtons.has(5) && (
                <div className="absolute right-[228px] top-[93px]">
                  <Panel881668 />
                </div>
              )}
              {viewActiveButtons.has(2) && (
                <div className="absolute bottom-[14px] left-1/2 translate-x-[-50%] w-[1014px] h-[68px]">
                  <Scale />
                </div>
              )}
      ...
      {currentPage === 'view' && layout === 'horizontal' && (
        <>
          ...
          {viewActiveButtons.has(2) && (
            <div className="absolute bottom-[105px] left-[14px] w-[1014px] h-[148px]">
              <Scale />
            </div>
          )}
          {viewActiveButtons.has(4) && (
            <div className="absolute bottom-[105px] left-[14px] w-[1014px] h-[68px]">
              <Scale833974 />
            </div>
          )}
        </>
